...
#         self.up6 = StackDecoder(512, kernel_size=3, dilation_rate=4)
        ...
        self.c1 =  ConvBnRelu2d(128, kernel_size=3, padding='same', dilation_rate=4)
        self.c2 =  ConvBnRelu2d(64, kernel_size=3, padding='same', dilation_rate=4)
        self.c3 =  ConvBnRelu2d(32, kernel_size=3, padding='same', dilation_rate=4)
